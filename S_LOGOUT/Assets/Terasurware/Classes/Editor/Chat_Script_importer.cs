...
public class Chat_Script_importer : AssetPostprocessor {
	private static readonly string filePath = "Assets/yjExelData/Chat_Script.xls";
	private static readonly string exportPath = "Assets/yjExelData/Chat_Script.asset";
